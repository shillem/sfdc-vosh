...
export default class AutocompleteCombobox extends LightningElement {
    ...
    get comboboxIconClass() {
        return (
            ...
            (this.empty ? "" : " slds-input__icon_clickable")
        );
    }
    ...
    get inputPlaceholder() {
        return this.minimum > 0
            ? `Type at least ${this.minimum} chars to search`
            : "Type to search";
    }
    ...
    @api get validity() {
        const state = {
            customError:
                typeof this.validationCustomMessage === "string" &&
                this.validationCustomMessage.length > 0,
